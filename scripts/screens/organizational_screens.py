...
class StartScreen(Screens):
    ...
    def screen_switches(self):
        ...
        self.warning_label = pygame_gui.elements.UITextBox(
            "Warning: this game includes some mild descriptions of gore, gun violence and war.",
...
class SwitchClanScreen(Screens):
    ...
    def screen_switches(self):
        ...
        self.info = pygame_gui.elements.UITextBox(
            'Note: This will close the game.\n When you open it next, it should have the new team.',  # pylint: disable=line-too-long
        ...
        if game.clan:
            self.current_clan.set_text(
                f"The currently loaded clan is {game.clan.name}Bots")
        else:
            self.current_clan.set_text("There is no team currently loaded.")

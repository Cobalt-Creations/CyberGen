...
class MakeClanScreen(Screens):
    ...
    classic_mode_text = "This mode is CyberGEN at it's most basic. " \
    ...
    expanded_mode_text = "A more hands-on experience. " \
                         ...
                         "- Resource gathering and medical treatment<br>" \
                         "- Ability to choose patrol type<br><br>" \
                         "With this mode you'll be making the important life or death decisions."
    ...
    def screen_switches(self):
        ...
        self.menu_warning = pygame_gui.elements.UITextBox(
            'Note: going back to main menu resets the generated bots.',
    ...
    def handle_name_clan_event(self, event):
        if event.ui_element == self.elements["random"]:
            ...
            if not new_name:
                self.elements["error"].set_text("Your team's name cannot be empty")
                self.elements["error"].show()
                return
            if new_name.casefold() in [clan.casefold() for clan in game.switches['clan_list']]:
                self.elements["error"].set_text("A team with that name already exists.")
                self.elements["error"].show()
                return
    ...
    def on_use(self):
        ...
        if self.sub_screen == 'name clan':
            if self.elements["name_entry"].get_text() == "":
                ...
                self.elements["error"].set_text("Team names cannot start with a space.")
                self.elements["error"].show()
                self.elements['next_step'].disable()
    ...
    def open_game_mode(self):
        ...
        self.elements['permi_warning'] = pygame_gui.elements.UITextBox(
            "Your team's game mode is permanent and cannot be changed after creation.",
    ...
    def open_name_clan(self):
        ...
        self.elements["clan"] = pygame_gui.elements.UITextBox("-Bots",
    ...
    def clan_name_header(self):
        ...
        self.elements["clan_name"] = pygame_gui.elements.UITextBox(self.clan_name + "Bots",
    ...
    def open_clan_saved_screen(self):
        ...
        self.elements["save_confirm"] = pygame_gui.elements.UITextBox('Your team has been created and saved!',

...
class EventsScreen(Screens):
    ...
    other_clans_events = ""
    misc_events = ""
    display_text = "<center> Check this page to see which events are currently happening in the team.</center>"
    display_events = ""
            ...
            if event.ui_element == self.timeskip_button:
                ...
                if self.event_display_type == "all events":
                    ...
                    if not self.all_events:
                        self.all_events.append(Single_Event("Nothing interesting happened this solar cycle."))
                ...
                if game.clan.closed_borders:
                    ...
                    self.toggle_borders_button.set_text("Close Team Borders")
                else:
                    game.clan.closed_borders = True
                    self.toggle_borders_button.set_text("Open Team Borders")
    ...
    def screen_switches(self):
        ...
        if game.clan.age == 1:
            self.clan_age.set_text(f'Team age: {game.clan.age} solar cycle')
        if game.clan.age != 1:
            self.clan_age.set_text(f'Team age: {game.clan.age} solar cycles')
